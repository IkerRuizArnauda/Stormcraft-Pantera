...
{
	char filename[256];
	sprintf(filename,"C:/Users/User/Desktop/WoWStorm/bin/Debug/Accounts/%s",Data.Name);
...
CAccount *LoadAccount(const char *name,bool createflag) {
	char filename[256];
	sprintf(filename,"C:/Users/User/Desktop/WoWStorm/bin/Debug/Accounts/%s",name);
	FILE *fin = fopen(filename, "rb");
	if(fin == NULL) {
		OutputDebugString("Creating Account!\n");
